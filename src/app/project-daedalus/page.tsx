      ...
      <header className="sticky top-0 z-50 bg-black/50 backdrop-blur-lg border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <h1 className="text-lg font-bold text-white">Project: Daedalus</h1>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="relative w-full h-96 md:h-[500px] rounded-3xl overflow-hidden border border-white/10 mb-12">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent flex flex-col justify-end p-8 md:p-12">
            <h2 className="text-4xl md:text-6xl font-extrabold text-white tracking-tight">Team Lead, Avionics & Integration</h2>
            <p className="text-lg text-slate-300 mt-2 max-w-2xl">Orchestrating the seamless fusion of hardware and software for a high-performance autonomous aerial system.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            {/* --- Key Metrics & Data --- */}
            <section>
              <h3 className="text-2xl font-bold text-white mb-6 uppercase tracking-widest font-mono">Core Metrics</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                
                <div className="bg-slate-900 border border-green-500/30 p-6 rounded-2xl">
                  <p className="text-green-400 text-sm font-mono uppercase mb-2">Validated T/W Ratio</p>
                ...
                <div className="bg-slate-900 border border-red-500/30 p-6 rounded-2xl">
                  <p className="text-red-400 text-sm font-mono uppercase mb-2">Peak Current</p>
            ...
            {/* --- Image Gallery --- */}
            <section>
                <h3 className="text-2xl font-bold text-white mb-6 uppercase tracking-widest font-mono">Gallery</h3>
          ...
          <aside className="lg:col-span-1 space-y-8 lg:sticky lg:top-24">
            <div className="bg-slate-900/70 border border-white/10 rounded-2xl p-6">
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li className="flex justify-between"><span className="text-slate-400">Timeline:</span> <span className="font-medium text-slate-200">5 Weeks</span></li>
