...
import { ChevronLeft, CheckCircle, Goal, ListChecks, Info, Layers, Code } from 'lucide-react';

export default function ArduinoLogicPage() {
  const codeSnippet = `
#include "HX711.h"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="bg-slate-900/50 border border-white/10 rounded-lg px-4 py-2">
                <h1 className="text-md font-bold text-white">Project: Arduino Logic</h1>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="relative w-full h-96 md:h-[500px] rounded-3xl overflow-hidden border border-white/10 mb-12 shadow-2xl shadow-blue-500/10">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent flex flex-col justify-end p-8 md:p-12">
            <h2 className="text-4xl md:text-6xl font-extrabold text-white tracking-tight drop-shadow-lg">Data Acquisition & Control</h2>
            <p className="text-lg text-slate-300 mt-2 max-w-3xl drop-shadow-lg">A custom-built Arduino-based system for precise data logging and real-time validation of aeronautical performance metrics.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-slate-900 rounded-3xl border border-white/10 shadow-2xl shadow-blue-500/10">
                <div className="flex items-center gap-x-4 p-8 pb-0">
                    <Code className="w-8 h-8 text-blue-400"/>
                    <h3 className="text-lg font-bold text-white uppercase tracking-widest font-mono">Code Snippet</h3>
                </div>
                 <SyntaxHighlighter language="cpp" style={vscDarkPlus} customStyle={{background: 'transparent'}}>
                    {codeSnippet}
                </SyntaxHighlighter>
            </section>
