  ...
  return (
    <div className="min-h-screen bg-black text-slate-200 p-4 md:p-8 font-sans selection:bg-blue-500/30">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 auto-rows-auto gap-4">
        ...
        <div className="md:col-span-2 md:row-span-2 bg-slate-900 rounded-3xl p-8 border border-white/10 flex flex-col justify-between transform transition-transform duration-300 hover:-translate-y-2 hover:border-blue-500/50 hover:shadow-lg hover:shadow-blue-500/10 group">
          <div>
          ...
          <div className="flex gap-4 mt-8">
            ...
            <a 
              ...
              className="px-6 py-2 bg-white text-black font-bold rounded-full hover:bg-blue-50 transition-colors text-center"
            >
              Download Resume
            </a>
            <button
        ...
        <div className="md:col-span-4 bg-slate-900 rounded-3xl p-8 border border-white/10 flex flex-col md:flex-row gap-8 transform transition-transform duration-300 hover:-translate-y-2 hover:border-green-500/30 hover:shadow-lg hover:shadow-green-500/10">
        ...
        <div className="md:col-span-4 bg-slate-900 rounded-3xl p-4 border border-white/10 flex flex-col gap-4 transform transition-transform duration-300 hover:-translate-y-2 hover:border-yellow-500/30 hover:shadow-lg hover:shadow-yellow-500/10">
        ...
        <div className="md:col-span-4 mt-8 mb-4 flex items-center gap-4">
           <h3 className="text-2xl font-bold text-white">Software Engineering</h3>
           <div className="h-px bg-white/10 flex-1"></div>
        </div>

        {/* --- CARD 6: RISC-V (1 col) --- */}
        <div className="md:col-span-1 bg-neutral-900 rounded-3xl p-6 border border-white/10 transform transition-transform duration-300 hover:-translate-y-2 hover:bg-neutral-800 hover:shadow-lg hover:shadow-purple-500/10 group">
        ...
        <div className="md:col-span-1 bg-neutral-900 rounded-3xl p-6 border border-white/10 transform transition-transform duration-300 hover:-translate-y-2 hover:bg-neutral-800 hover:shadow-lg hover:shadow-orange-500/10 group">
        ...
        <div className="md:col-span-1 bg-neutral-900 rounded-3xl p-6 border border-white/10 transform transition-transform duration-300 hover:-translate-y-2 hover:bg-neutral-800 hover:shadow-lg hover:shadow-blue-500/10 group">
        ...
        <div className="md:col-span-1 bg-neutral-900 rounded-3xl p-6 border border-white/10 transform transition-transform duration-300 hover:-translate-y-2 hover:bg-neutral-800 hover:shadow-lg hover:shadow-red-500/10 group">
